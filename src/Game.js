...
export class Game {
  ...
  async _loadAssets() {
    ...
    await this.assets.loadAll({
      ...
      images: [
        // Тайли
        { key: 'tile_grass_1',  src: 'assets/sprites/surfaces/gras1.png'   },
        { key: 'tile_grass_2',  src: 'assets/sprites/surfaces/gras2.png'   },
        { key: 'tile_grass_3',  src: 'assets/sprites/surfaces/gras3.png'   },
        { key: 'tile_water_1',  src: 'assets/sprites/surfaces/water1.png'  },
        { key: 'tile_water_2',  src: 'assets/sprites/surfaces/water2.png'  },
        { key: 'tile_rock_1',   src: 'assets/sprites/surfaces/rock1.png'   },
        { key: 'tile_rock_2',   src: 'assets/sprites/surfaces/rock2.png'   },
        { key: 'tile_rock_3',   src: 'assets/sprites/surfaces/rock3.png'   },
        { key: 'tile_sand_1',   src: 'assets/sprites/surfaces/sand1.png'   },
        { key: 'tile_sand_2',   src: 'assets/sprites/surfaces/sand2.png'   },
        { key: 'tile_sand_3',   src: 'assets/sprites/surfaces/sand3.png'   },
        { key: 'tile_bridge',   src: 'assets/sprites/tiles/bridge.png'     },
        // Будівлі
        { key: 'wall',              src: 'assets/sprites/buildings/stonewall.png'         },
        { key: 'reinforced_wall',   src: 'assets/sprites/buildings/betonwall.png'         },
        { key: 'gold_mine',         src: 'assets/sprites/buildings/minelvl1.png'          },
        { key: 'gold_mine_lvl2',    src: 'assets/sprites/buildings/minelvl2.png'          },
        { key: 'treasury',          src: 'assets/sprites/buildings/depositorylvl1.png'    },
        { key: 'treasury_lvl2',     src: 'assets/sprites/buildings/depositorylvl2.png'    },
        { key: 'barracks',          src: 'assets/sprites/buildings/barracklvl1.png'       },
        { key: 'barracks_lvl2',     src: 'assets/sprites/buildings/barracklvl2.png'       },
        { key: 'tower',             src: 'assets/sprites/buildings/archertawer.png'       },
        { key: 'cannon_tower',      src: 'assets/sprites/buildings/cannontawer.png'       },
